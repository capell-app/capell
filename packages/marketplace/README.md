...
| Heartbeat/update check fails                          | The `PhoneHomeAction::result()` failure message or admin notification copy                                         | Set `APP_URL` or `CAPELL_MARKETPLACE_WEBHOOK_URL`, confirm an instance exists, and check network access to the API URL.                                                                                                                                                                                                                              |
