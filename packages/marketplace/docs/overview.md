...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <picture><source media="(prefers-color-scheme: dark)" srcset="images/screenshots/marketplace-extensions-page-dark.png"><img src="images/screenshots/marketplace-extensions-page.png" alt="Marketplace extensions browser with installed and available packages"></picture><br>[Light](images/screenshots/marketplace-extensions-page.png) · [Dark](images/screenshots/marketplace-extensions-page-dark.png)                                                                   | <picture><source media="(prefers-color-scheme: dark)" srcset="images/screenshots/extension-update-advisories-dark.png"><img src="images/screenshots/extension-update-advisories.png" alt="Marketplace update advisories with version and security context"></picture><br>[Light](images/screenshots/extension-update-advisories.png) · [Dark](images/screenshots/extension-update-advisories-dark.png)                                                                                         |
