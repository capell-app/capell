<template x-teleport="#capell-marketplace-browser-modal-footer">
    ...
    >
        <span wire:loading.remove wire:target="showMarketplaceInstallReview">
            {{ __('capell-marketplace::marketplace.selection.install_footer_action') }}
        </span>

        <span wire:loading.flex wire:target="showMarketplaceInstallReview" class="hidden items-center gap-2">
