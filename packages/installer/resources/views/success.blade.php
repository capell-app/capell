        ...
        <div class="panel-body completion-panel">
            <section class="section completion-security-panel">
                <div class="completion-security-copy">
                    <h2>{{ __('capell-installer::installer.remove_installer_recommendation_heading') }}</h2>
            ...
            <section class="section completion-success-panel">
                <div class="completion-primary-column">
                    ...
                    <div class="completion-copy">
                        <h2>{{ __('capell-installer::installer.launchpad_heading') }}</h2>
                    </div>

                    @if ($primaryAdmin !== null)
                        <div class="launchpad-account-summary">
                            <strong> {{ __('capell-installer::installer.launchpad_primary_admin') }} </strong>
                ...
                <div class="completion-launch-column">
                    <div class="completion-checklist">
                        <h3>{{ __('capell-installer::installer.launchpad_checklist_title') }}</h3>
                        <p>{{ __('capell-installer::installer.launchpad_message') }}</p>

                        <ul>
                            <li>{{ __('capell-installer::installer.launchpad_check_pages') }}</li>
                            <li>{{ __('capell-installer::installer.launchpad_check_site_settings') }}</li>

                            @if ($roleUsersCreated)
                                <li>{{ __('capell-installer::installer.launchpad_check_roles') }}</li>
                            @endif
                        </ul>
                    </div>

                    <div class="completion-actions">
                        <a class="button secondary" href="{{ url('/admin') }}">
                            {{ __('capell-installer::installer.go_to_admin') }}
                        </a>
                        <a class="button secondary" href="{{ url('/') }}">
