...
![Public/cache delivery separated from authenticated post-load authoring, private preview, and unsafe-to-cache bypass](../../docs/images/capell-public-authoring-cache-boundary.svg)

_The public boundary is a conceptual contract, not a runtime screenshot. Read the [canonical Mermaid source](../../docs/images/capell-public-authoring-cache-boundary.mmd) and [public HTML safety contract](../../docs/frontend/public-html-safety.md) alongside the renderer code._
