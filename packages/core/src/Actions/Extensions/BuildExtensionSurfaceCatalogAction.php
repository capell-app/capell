...
final class BuildExtensionSurfaceCatalogAction
{
    ...
    private function foundationEntries(): array
    {
        return [
            ...
            $this->entry('frontend.action.build-page-schema-graph', 'action', 'Capell\\Frontend\\Actions\\BuildPageSchemaGraphAction', ExtensionSurfaceStability::Stable, 'Merged per-page schema.org graph construction.', 'frontend.build-page-schema-graph', owner: 'capell-app/frontend'),
            $this->entry('frontend.action.resolve-page-social-meta', 'action', 'Capell\\Frontend\\Actions\\ResolvePageSocialMetaAction', ExtensionSurfaceStability::Stable, 'Resolved Open Graph and Twitter metadata for public pages.', 'frontend.resolve-page-social-meta', owner: 'capell-app/frontend'),
            ...
            $this->entry('frontend.contract.page-variant-negotiator', 'contract', 'Capell\\Frontend\\Contracts\\PageVariantNegotiator', ExtensionSurfaceStability::Stable, 'Typed resolved-page response variant negotiation boundary.', 'frontend.page-variant-negotiator', owner: 'capell-app/frontend'),
            $this->entry('frontend.contract.robots-directive-contributor', 'contract', 'Capell\\Frontend\\Contracts\\RobotsDirectiveContributor', ExtensionSurfaceStability::Stable, 'Typed robots.txt crawler policy contribution boundary.', 'frontend.robots-directive-contributor', owner: 'capell-app/frontend'),
            $this->entry('frontend.contract.schema-graph-contributor', 'contract', 'Capell\\Frontend\\Contracts\\SchemaGraphContributor', ExtensionSurfaceStability::Stable, 'Per-blueprint schema.org graph contribution boundary.', 'frontend.schema-graph-contributor', owner: 'capell-app/frontend'),
            ...
            $this->entry('frontend.dto.social-meta', 'dto', 'Capell\\Frontend\\Data\\SocialMetaData', ExtensionSurfaceStability::Stable, 'Typed public social metadata.', 'frontend.social-meta-data', owner: 'capell-app/frontend'),
            $this->entry('frontend.dto.robots-directive', 'dto', 'Capell\\Frontend\\Data\\RobotsDirectiveData', ExtensionSurfaceStability::Stable, 'Typed robots.txt user-agent policy.', 'frontend.robots-directive-data', owner: 'capell-app/frontend'),
            ...
            $this->entry('frontend.tag.aeo-route-provider', 'tagged-service', 'capell-frontend.aeo-route-provider', ExtensionSurfaceStability::Stable, 'Container tag for exact-path AEO response providers.', 'frontend.aeo-route-provider-registration', owner: 'capell-app/frontend'),
            ...
            $this->entry('frontend.tag.page-variant-negotiator', 'tagged-service', 'capell-frontend.page-variant-negotiator', ExtensionSurfaceStability::Stable, 'Container tag for resolved-page response variant negotiators.', 'frontend.page-variant-negotiator-registration', owner: 'capell-app/frontend'),
            $this->entry('frontend.tag.robots-directive-contributor', 'tagged-service', 'capell-frontend.robots-directive-contributor', ExtensionSurfaceStability::Stable, 'Container tag for robots.txt crawler policy contributors.', 'frontend.robots-directive-contributor-registration', owner: 'capell-app/frontend'),
            $this->entry('frontend.tag.schema-graph-contributor', 'tagged-service', 'capell-frontend.schema-graph-contributor', ExtensionSurfaceStability::Stable, 'Container tag for schema.org graph contributors.', 'frontend.schema-graph-contributor-registration', owner: 'capell-app/frontend'),
