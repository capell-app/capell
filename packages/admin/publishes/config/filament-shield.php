...
return [
    ...
    */
    ...
    'policies' => [
        ...
        'merge' => true,
        // Capell ships its own policies (Capell\Admin\Policies\*); we never want
        // shield:generate to scaffold stub policies into app/Policies on install.
        // Setting this to false makes Utils::getGeneratorOption() default to
        // 'permissions', so any call to shield:generate (with or without
        // --option) skips policy file generation.
        'generate' => false,
        'methods' => [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Like pages, elements typically only need view permissions. Add elements
    ...
    */
    ...
    | elements. Define any custom permissions here and they'll be available
