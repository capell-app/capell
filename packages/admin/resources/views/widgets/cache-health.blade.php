        ...
        @else
            ...
            @if ($total > 0)
                <div class="mb-4 flex items-center gap-4">
                    ...
                    <span class="shrink-0 text-sm font-medium text-gray-700 tabular-nums dark:text-gray-300">
            ...
            <div class="mb-4 grid grid-cols-3 gap-3">
                <div class="bg-success-50 dark:bg-success-900/20 rounded-lg p-3 text-center">
                    <div class="text-success-700 dark:text-success-400 text-2xl font-bold tabular-nums">
                        {{ $data->cachedCount }}
                    </div>
                    <div class="text-success-600 dark:text-success-500 mt-1 text-xs">Cached</div>
                </div>

                <div class="bg-warning-50 dark:bg-warning-900/20 rounded-lg p-3 text-center">
                    <div class="text-warning-700 dark:text-warning-400 text-2xl font-bold tabular-nums">
                        {{ $data->staleCount }}
                    </div>
                    <div class="text-warning-600 dark:text-warning-500 mt-1 text-xs">Stale</div>
                </div>

                <div class="{{ $data->missingCount > 0 ? 'bg-danger-50 dark:bg-danger-900/20' : 'bg-gray-50 dark:bg-gray-800' }} rounded-lg p-3 text-center">
                    <div class="{{ $data->missingCount > 0 ? 'text-danger-700 dark:text-danger-400' : 'text-gray-500 dark:text-gray-400' }} text-2xl font-bold tabular-nums">
                        {{ $data->missingCount }}
                    </div>
                    <div class="{{ $data->missingCount > 0 ? 'text-danger-600 dark:text-danger-500' : 'text-gray-400 dark:text-gray-500' }} mt-1 text-xs">
                        Missing
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                >
                    <span wire:loading.remove wire:target="warmCache"> Warm cache </span>
