<div class="text-xs font-medium text-gray-500 uppercase dark:text-gray-400">{{ $stat->group }}</div>
...
<div class="mt-2 flex items-start justify-between gap-3">
    <div>
        ...
        @if ($stat->description !== null)
            <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ $stat->description }}</div>
        @endif
    </div>
