        ...
        <div class="space-y-4">
            ...
            <div class="grid gap-3 md:grid-cols-2">
                @foreach ($this->advisories() as $advisory)
                    <article class="border-danger-200 bg-danger-50 dark:border-danger-800/60 dark:bg-danger-950/30 rounded-xl border p-4">
                        <div class="flex flex-wrap items-center gap-2">
                            <span class="bg-danger-100 text-danger-700 dark:bg-danger-900/60 dark:text-danger-200 rounded-full px-2 py-1 text-xs font-semibold tracking-wide uppercase">
