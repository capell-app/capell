...
>
    <div class="fixed-sidebar__wrapper flex max-w-full min-w-0 flex-wrap gap-6 @4xl:flex-nowrap">
        <aside
        ...
        >
            <div :class="showModal ? '' : 'sticky top-20'">{{ $getChildSchema('sidebar') }}</div>
        </aside>
        <section class="fixed-sidebar__main order-1 max-w-full min-w-0 shrink grow basis-full @4xl:order-1 @4xl:basis-0">
            <div :class="showModal ? '' : 'sticky top-20'">{{ $getChildSchema('main') }}</div>
        </section>
    </div>
