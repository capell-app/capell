...
<div class="space-y-4">
    @if (! $isImage)
        <div class="rounded-lg border border-gray-200 bg-gray-50 px-4 py-8 text-center text-sm text-gray-600 dark:border-white/10 dark:bg-white/5 dark:text-gray-300">
    ...
    @else
        <div class="grid gap-4 lg:grid-cols-[minmax(0,1fr)_18rem]">
            <div class="space-y-2">
                ...
                <div class="relative overflow-hidden rounded-lg border border-gray-200 bg-gray-950 shadow-sm dark:border-white/10">
                    ...
                    <div class="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,.26)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,.26)_1px,transparent_1px)] bg-[size:33.333%_33.333%]"></div>
                    ...
                    <div
                        ...
                        style="left: {{ $x }}%; top: {{ $y }}%"
                    >
                        <span class="absolute top-0 left-1/2 h-full w-px -translate-x-1/2 bg-white"></span>
                        <span class="absolute top-1/2 left-0 h-px w-full -translate-y-1/2 bg-white"></span>
                        <span class="absolute top-1/2 left-1/2 h-2 w-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white"></span>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-2 gap-3 lg:grid-cols-1">
                        @foreach ($presets as $preset)
                            <div class="self-start overflow-hidden rounded-lg border border-gray-200 bg-gray-950 dark:border-white/10">
                                <div
                                    class="relative"
                                    style="
                                ...
                                <div class="flex items-center justify-between gap-2 border-t border-white/10 px-3 py-2">
                                    ...
                                    <span class="shrink-0 text-xs text-gray-300"> {{ $preset['ratio'] }} </span>
                                </div>
                            </div>
                        @endforeach
                    </div>
