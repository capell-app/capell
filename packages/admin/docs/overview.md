...
| Dashboard                                                                                                                                                                                                                                                                                                                                           | Pages                                                                                                                                                                                                                                                                                                                                             |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <picture><source media="(prefers-color-scheme: dark)" srcset="images/screenshots/admin-dashboard-dark.png"><img src="images/screenshots/admin-dashboard.png" alt="Admin dashboard with site context and operational cards"></picture><br>[Light](images/screenshots/admin-dashboard.png) · [Dark](images/screenshots/admin-dashboard-dark.png)      | <picture><source media="(prefers-color-scheme: dark)" srcset="images/screenshots/admin-pages-list-dark.png"><img src="images/screenshots/admin-pages-list.png" alt="Pages list with page hierarchy and publishing state"></picture><br>[Light](images/screenshots/admin-pages-list.png) · [Dark](images/screenshots/admin-pages-list-dark.png)    |
...
| **Revert selected pages to draft**                                                                                                                          | **Rollback preview**                                                                                                                           |
| [![Bulk revert-to-draft confirmation preserving current content](images/screenshots/bulk-revert-to-draft.png)](images/screenshots/bulk-revert-to-draft.png) | [![Page history rollback preview](images/screenshots/page-history-rollback-preview.png)](images/screenshots/page-history-rollback-preview.png) |
