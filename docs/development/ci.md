...
The `.github/workflows/update-pest-shards.yml` workflow runs weekly and on demand. When timings change, it commits only `tests/.pest/shards.json` and opens a PR against `main`.
