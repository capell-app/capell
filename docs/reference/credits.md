...
| [GitHub](https://github.com)                        | GitHub hosts Capell's private source repositories, issue workflow, pull requests, code review, and automation. Repository access is limited to authorised maintainers and customers where their agreement provides it.                                                                            |
