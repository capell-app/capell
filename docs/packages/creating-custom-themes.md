...
Theme CSS and JavaScript use the typed [Frontend resource graph](../../packages/frontend/frontend-resources.md). Editor metadata may select trusted groups or local paths, but cannot introduce remote or inline executable code.
