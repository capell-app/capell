...
| Reduce rendered HTML size                | [Frontend server configuration](../../packages/frontend/server-config.md) |
...
See also: [`packages/core/docs/cache.md`](../../packages/core/cache.md), [`packages/core/docs/extending-capell.md`](../../packages/core/extending-capell.md).
