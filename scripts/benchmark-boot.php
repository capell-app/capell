...
try {
    ...
    throw new InvalidArgumentException($invalidArgumentException->getMessage() . PHP_EOL . BootBenchmarkOptions::usage(), $invalidArgumentException->getCode(), previous: $invalidArgumentException);
}
