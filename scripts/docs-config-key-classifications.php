...
return [
    ...
    'capell.install.recommendations.blog.demo' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.blog.description' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.blog.label' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.blog.order' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.blog.packages' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.blog.theme' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.headless.demo' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.headless.description' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.headless.label' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.headless.order' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.headless.packages' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.marketing.demo' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.marketing.description' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.marketing.label' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.marketing.order' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.marketing.packages' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    'capell.install.recommendations.marketing.theme' => 'Public installer recommendation default; configured as a deterministic bundle rather than a standalone override.',
    ...array_fill_keys(
        $internalDefaultColors,
