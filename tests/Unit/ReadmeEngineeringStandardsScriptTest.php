...
function readmeEngineeringStandardsFixture(string $root): void
{
    ...
    file_put_contents($root . '/README.md', 'PHPStan-level%208 parameters%20typed-99.2%25 dependencies-audited test-full.yml?branch=main&style=flat-square&label=test%20matrix code-quality-and-styling.yml?branch=main&style=flat-square&label=quality%20gates img.shields.io/codecov/c/github/capell-app/capell');
