...
* Consolidate Capell release workstreams by @capell-app-user in https://github.com/capell-app/capell/pull/1
* chore: remove internal planning and assistant artifacts by @howdu in https://github.com/capell-app/capell/pull/2
* Finalize Capell Core v1 release safety by @capell-app-user in https://github.com/capell-app/capell/pull/3
* Start Capell release line at 0.0.1 by @capell-app-user in https://github.com/capell-app/capell/pull/4
* Pin Filament prerelease for deterministic v0.0.1 installs by @capell-app-user in https://github.com/capell-app/capell/pull/5
* Complete public release theme modernization by @capell-app-user in https://github.com/capell-app/capell/pull/6
* Advance public split compatibility to v0.0.2 by @capell-app-user in https://github.com/capell-app/capell/pull/7
* Release: consolidate completed Capell work by @capell-app-user in https://github.com/capell-app/capell/pull/8
* Release: advance split packages to v0.0.3 by @capell-app-user in https://github.com/capell-app/capell/pull/9
* Support stable Filament 5.6 in v0.0.1 by @capell-app-user in https://github.com/capell-app/capell/pull/10
* Release: advance split packages to v0.0.4 by @capell-app-user in https://github.com/capell-app/capell/pull/11
* docs: add agency proof install by @capell-app-user in https://github.com/capell-app/capell/pull/12
* Fix: align extension API with 0.0 release line by @capell-app-user in https://github.com/capell-app/capell/pull/13
* Safely align Core split branches by @capell-app-user in https://github.com/capell-app/capell/pull/14
* Close owner release-readiness blockers by @capell-app-user in https://github.com/capell-app/capell/pull/15
* fix(release): align split package constraints by @capell-app-user in https://github.com/capell-app/capell/pull/16
* Fix: reproduce production PageUrl domain resolution by @capell-app-user in https://github.com/capell-app/capell/pull/17
* Preserve legacy blueprint relationship state by @capell-app-user in https://github.com/capell-app/capell/pull/19
* Fix all failing GitHub Actions workflows by @capell-app-user in https://github.com/capell-app/capell/pull/18
* fix: reconcile public URL domain resolution by @capell-app-user in https://github.com/capell-app/capell/pull/21
* merge: reconcile owner go-live work with current main by @capell-app-user in https://github.com/capell-app/capell/pull/22
* Fix: complete owner go-live reconciliation by @capell-app-user in https://github.com/capell-app/capell/pull/20
* Fix screenshot runner theme checkout by @capell-app-user in https://github.com/capell-app/capell/pull/24
* Align page guide test with optional screenshot fixtures by @capell-app-user in https://github.com/capell-app/capell/pull/25
* Fix split release preflight by @capell-app-user in https://github.com/capell-app/capell/pull/27
* Update CHANGELOG for v2.0.86 by @capell-app-user in https://github.com/capell-app/capell/pull/26
...
* Allow dependency changes in release smoke install by @capell-app-user in https://github.com/capell-app/capell/pull/31
* Update CHANGELOG for v2.0.88 by @capell-app-user in https://github.com/capell-app/capell/pull/30

### New Contributors

* @capell-app-user made their first contribution in https://github.com/capell-app/capell/pull/1
* @howdu made their first contribution in https://github.com/capell-app/capell/pull/2

**Full Changelog**: https://github.com/capell-app/capell/commits/v0.0.15
...
**Full Changelog**: https://github.com/capell-app/capell/commits/v2.0.87
...
**Full Changelog**: https://github.com/capell-app/capell/commits/v2.0.86
